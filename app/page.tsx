...
// Le composant d'interface
export default function Home() {
  const [messages, setMessages] = useState<{ id: number; role: 'user' | 'zeus'; content: string }[]>([
      ...
      <footer className="fixed bottom-0 w-full p-6 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a] to-transparent">
        <div className="max-w-2xl mx-auto space-y-2">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-2 flex items-center shadow-2xl backdrop-blur-xl">
            <button onClick={() => fileInputRef.current?.click()} className="p-3 text-gray-400 hover:text-white transition">
...
// Les métadonnées pour le SEO (Next.js les détectera ici)
export const metadata = {
  title: "Zeus Généalogie | Assistant IA",
  description: "Recherche généalogique assistée par IA.",
  verification: {
